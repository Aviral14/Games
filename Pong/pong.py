...
class Ball(games.Sprite):
	...
	def __init__(self):
		super(Ball,self).__init__(image=self.image,x=650,y=325,dx=4.5,dy=4.5)
		if Ball.time==100:
			self.show_time=games.Text(value=Ball.time,size=40,color=color.red,x=652.5,y=35)
...
text2=games.Text(value="Player-2(up,down)",size=40,color=color.red,x=613,y=35)
text2.left=800
...
p1.left=0
games.screen.add(p1)
p2=Bar(pos=games.screen.width,scorex=1175,images=image2,a=games.K_UP,b=games.K_DOWN)
